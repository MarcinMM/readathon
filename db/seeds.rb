...
Avatar.create(id: 37, level_id: 10, category: 'dragon')
Avatar.create(id: 38, level_id: 10, category: 'princess')
Avatar.create(id: 39, level_id: 10, category: 'animal')
Avatar.create(id: 40, level_id: 10, category: 'sport')
Avatar.create(id: 41, level_id: 11, category: 'dragon')
Avatar.create(id: 42, level_id: 11, category: 'princess')
Avatar.create(id: 43, level_id: 11, category: 'animal')
Avatar.create(id: 44, level_id: 11, category: 'sport')
Avatar.create(id: 45, level_id: 12, category: 'dragon')
Avatar.create(id: 46, level_id: 12, category: 'princess')
Avatar.create(id: 47, level_id: 12, category: 'animal')
Avatar.create(id: 48, level_id: 12, category: 'sport')
Avatar.create(id: 49, level_id: 13, category: 'dragon')
Avatar.create(id: 50, level_id: 13, category: 'princess')
